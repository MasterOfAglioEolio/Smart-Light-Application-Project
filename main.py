...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        ## SET ==> WINDOW TITLE
        self.setWindowTitle('Light Is Right')
        UIFunctions.labelTitle(self, 'LIGHT IS RIGHT')
        ...
        # background=self.ui.emotionClicked
        # print(background)
        UIFunctions.addNewMenu(self, "Function", "btn_home", "url(:/16x16/icons/16x16/cil-lightbulb.png)", True)
        UIFunctions.addNewMenu(self, "Place", "btn_settings", "url(:/16x16/icons/16x16/cil-satelite.png)", True)
